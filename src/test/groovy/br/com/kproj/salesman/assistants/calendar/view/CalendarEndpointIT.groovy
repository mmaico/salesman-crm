...
class CalendarEndpointIT extends AbstractIntegrationTest {
    ...
    def "Should find calendar by ID"() {
        ...
        then: "Should return 1 calendar"
            ...
            resultJson.item.links.find{it.rel == "has-activities"}.href == "/users/calendars/2/calendar-activities"
    }
    ...
    def "Should create a calendar for user"() {
        ...
        then: "Should return 1 calendar"
            ...
            resultJson.item.links.find{it.rel == "has-activities"}.href == "/users/calendars/${resultJson.item.id}/calendar-activities"
    }
