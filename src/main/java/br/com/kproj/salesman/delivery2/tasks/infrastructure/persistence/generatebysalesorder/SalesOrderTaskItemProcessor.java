package br.com.kproj.salesman.delivery2.tasks.infrastructure.persistence.generatebysalesorder;

import br.com.kproj.salesman.delivery2.tasks.domain.model.sales.SalesOrder;
import br.com.kproj.salesman.delivery2.tasks.infrastructure.persistence.generatebysalesorder.convert.TaskTemplateToTask;
import br.com.kproj.salesman.delivery2.tasks.infrastructure.persistence.springdata.TaskTemplateRepositorySpringData;
