...
import br.com.kproj.salesman.negotiation2.domain.model.approval.ExcludesMe;
import br.com.kproj.salesman.negotiation2.domain.model.negotiation.*;
...
public class RulesToChangeTemperatureImpl implements RulesToChangeTemperature {
    ...
    {
        persistRules.put(description("negotiation.in.approval.process"),
        ...
        persistRules.put(description("negotiation.not.found"),
                (seller, negotiation) -> !negotiationRepository.findOne(negotiation.getNegotiation().getId()).isPresent());

        persistRules.put(description("negotiation.already.closedwon"),
                (seller, negotiation) -> {
